...
console.log(
  `La lista combinada es: ${combineProductLists(productsWithP, bestSellers)}`
);
...
function findProductWithLetter(productsList, letter) {
  ...
  return especificProduct
    ? `Producto con ${letter}: ${especificProduct}`
    : `No existe ningun producto con ${letter}`;
}
